...
const TherapistList = () => {
    ...
    const {therapists, token, getAllTherapists, changeAvailability} = useContext(AdminContext)
                ...
                therapists.map((item,index)=>(
                    ...
                    <div className='p-4'>
                        ...
                        <div className='mt-2 flex items-center gap-1 text-sm'>
                            <input onChange={()=> changeAvailability(item._id)} className='cursor-pointer' type="checkbox" checked={item.available} />
                            <p>Available</p>
                        </div>
                    </div>
                    </div>
